...
INSERT INTO `user` (`id`, `email`, `name`, `password`, `username`, `enabled`) VALUES (1, 'admin@lib.com', 'Admin', '$2a$10$D/kdBoAuwGix14QtatA1Zuzykte3sSH1I6QnKLqJO2Aehmd7IpbDq', 'admin', 1);
INSERT INTO `user` (`id`, `email`, `name`, `password`, `username`, `enabled`) VALUES (2, 'lib_foo@lib.com', 'Alex', '$2a$10$D/kdBoAuwGix14QtatA1Zuzykte3sSH1I6QnKLqJO2Aehmd7IpbDq6', 'lib.alex', 1);
INSERT INTO `user` (`id`, `email`, `name`, `password`, `username`, `enabled`) VALUES (3, 'user_lib@lib.com', 'John', '$2a$10$D/kdBoAuwGix14QtatA1Zuzykte3sSH1I6QnKLqJO2Aehmd7IpbDq', 'lib.john', 1);
